...
export const SEED_JOURNEY_STEPS: JourneyStep[] = [
  ...
  },
  {
    ...
    location: { nl: "Dome", en: "Dome" },
    description: {
      nl: "Bezoek een talk of de AI-ervaring in de Dome en voer de code in.",
      en: "Visit a talk or the AI experience in the Dome and enter the code.",
    },
    qrCode: "JOURNEY-DOME",
    accent: "blue",
    points: 100,
...
export const SEED_CHALLENGES: Challenge[] = [
  ...
  },
  {
    ...
    description: {
      nl: "Speel een old-school arcade game bij de Dome.",
      en: "Play an old-school arcade game near the Dome.",
    },
    points: 30,
    accent: "green",
    payload: {
