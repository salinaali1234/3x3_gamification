...
export const SEED_REWARDS: Reward[] = [
  {
    id: "rw-tier-1-mix",
    name: { nl: "Sticker / AirPods case", en: "Sticker / AirPods case" },
    description: {
      nl: "Tier 1 — kies een sticker of AirPods case (mix & match) bij de reward desk.",
      en: "Tier 1 — pick a sticker or AirPods case (mix & match) at the reward desk.",
    },
    type: "airpods_case",
    verifiable: true,
    costPoints: 50,
  ...
  {
    id: "rw-tier-2-keychain",
    name: { nl: "3x3 keychain", en: "3x3 keychain" },
    description: {
      nl: "Tier 2 — officiële 3x3 keychain bij de reward desk. Daglimiet: vrijdag 50 · zaterdag 100 · zondag 100.",
      en: "Tier 2 — official 3x3 keychain at the reward desk. Daily cap: Fri 50 · Sat 100 · Sun 100.",
    },
    type: "merch_voucher",
    verifiable: true,
    costPoints: 120,
  ...
  },
  {
    ...
    description: {
      nl: "Tier 3 — 20% korting in de Unites merch store op het terrein. Alleen vandaag, alleen fysiek in de winkel.",
      en: "Tier 3 — 20% off at the Unites merch store on site. Today only, in-store redemption only.",
    },
    type: "merch_voucher",
    verifiable: false,
    costPoints: 200,
  ...
  },
  {
    ...
    description: {
      nl: "Tier 4 — officiële 3x3 streetball bij de reward desk. Daglimiet: vrijdag 2 · zaterdag 5 · zondag 5.",
      en: "Tier 4 — official 3x3 streetball at the reward desk. Daily cap: Fri 2 · Sat 5 · Sun 5.",
    },
    type: "ball",
    verifiable: true,
    costPoints: 350,
